...
docker tag mcr.microsoft.com/dotnet/core/sdk:3.1  300213723870.dkr.ecr.us-west-2.amazonaws.com/base-images:dotnet-3.1-sdk
...
docker tag mcr.microsoft.com/dotnet/core/runtime:3.1  300213723870.dkr.ecr.us-west-2.amazonaws.com/base-images:dotnet-3.1-runtime
docker tag mcr.microsoft.com/dotnet/core/aspnet:3.1  300213723870.dkr.ecr.us-west-2.amazonaws.com/base-images:dotnet-3.1-aspnetcore-runtime
...
docker push  300213723870.dkr.ecr.us-west-2.amazonaws.com/base-images:dotnet-3.1-sdk
...
docker push  300213723870.dkr.ecr.us-west-2.amazonaws.com/base-images:dotnet-3.1-runtime
docker push  300213723870.dkr.ecr.us-west-2.amazonaws.com/base-images:dotnet-3.1-aspnetcore-runtime
