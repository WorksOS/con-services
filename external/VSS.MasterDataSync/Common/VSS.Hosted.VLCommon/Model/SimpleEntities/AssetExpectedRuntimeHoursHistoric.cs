...
{
    public partial class AssetExpectedRuntimeHoursHistoric
    {
        ...
        public virtual int WeekOfKeyDate
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.AssetExpectedRuntimeHoursHistoric.Contains(this))
            {
                previousValue.AssetExpectedRuntimeHoursHistoric.Remove(this);
            }
    
            if (Asset != null)
            {
                if (!Asset.AssetExpectedRuntimeHoursHistoric.Contains(this))
                {
                    Asset.AssetExpectedRuntimeHoursHistoric.Add(this);
                }
