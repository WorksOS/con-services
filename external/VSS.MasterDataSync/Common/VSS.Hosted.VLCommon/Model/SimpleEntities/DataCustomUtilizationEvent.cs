...
{
    public partial class DataCustomUtilizationEvent
    {
        ...
        public virtual int ifk_DimCustomUtilizationEventTypeID
        {
            get;
            set;
        }
        ...
        public virtual int ifk_OEMDataSourceTypeID
        {
            get;
            set;
        }
    
        public virtual Nullable<int> OEMDataSourceValue
        {
            get;
            set;
        }
