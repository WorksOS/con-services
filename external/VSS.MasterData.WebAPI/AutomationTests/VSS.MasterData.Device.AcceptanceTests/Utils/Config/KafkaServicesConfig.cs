...
namespace VSS.MasterData.Device.AcceptanceTests.Utils.Config
{
    public class KafkaServicesConfig
    {
        ...
        public static string KafkaUri = DeviceServiceConfig.DeviceServiceKafkaUri;
    ...
    private static void InitializeRPLProducer(string inputTopic)
      ...
      else if (KafkaDriver.Equals(JAVA))
      {
        ...
        public static void InitializeKafkaConsumer(IHandler handler)
        {
            ...
            {
                GroupName = DeviceServiceConfig.KafkaGroupName,
                TopicName = DeviceServiceConfig.DeviceServiceTopic,
                KafkaUri = KafkaUri,
                AutoCommit = true,
                BatchRead = false,
                ReadAsync = true,
            ...
            LogResult.Report(Log, "log_ForInfo", "Kafka Consumer Initialized For " + "Topic: " + DeviceServiceConfig.DeviceServiceTopic);
