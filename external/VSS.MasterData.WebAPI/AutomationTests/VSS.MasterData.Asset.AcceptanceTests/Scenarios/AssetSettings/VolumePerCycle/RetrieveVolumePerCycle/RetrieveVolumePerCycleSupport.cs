...
{
   public class RetrieveVolumePerCycleSupport
    {
        #region Variables
        ...
        public string CustomerUID = ConfigurationManager.AppSettings["CustomerUID"];
        ...
        //{
        //    {
        //        AccessToken = AutomationCore.API.Framework.Common.Features.TPaaS.TokenService.GetAccessToken("https://identity-stg.trimble.com/token?grant_type=password&username=alagammai_annamalai%2b10035%40trimble.com&password=Sanjayalagi1%40", ConsumerKey, ConsumerSecret);
        ...
        public void SetVolumePerCycleAPIDefaultValues(List<string> assetUIDs = null)
        {
        ...
        public POSTVolumePerCycleResponse PostVolumePerCycleRequest()
        {
            ...
            try
            {
                string VolumePerCycleRequestString = GetCreateAssetRequestString();
                //CustomHeaders.Add(CustomerUid, CustomerUID);
