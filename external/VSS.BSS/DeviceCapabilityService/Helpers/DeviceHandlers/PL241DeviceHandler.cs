...
{
  public class PL241DeviceHandler : IDeviceHandlerStrategy
  {
    public PL241DeviceHandler(IEnumerable<string> outboundEndpointNames)
    {
    ...
    {
      get { throw new NotImplementedException(DeviceHandlerExceptionHelper.NotCurrentlyImplemented(DeviceTypeEnum.PL241, "SetDailyReportFrequencyEventType")); }
    }

    public Type SetReportFrequencyEventType
    {
      get { throw new NotImplementedException(DeviceHandlerExceptionHelper.NotCurrentlyImplemented(DeviceTypeEnum.PL241, "SetReportFrequencyEventType")); }
    }
    ...
    {
      get { throw new NotImplementedException(DeviceHandlerExceptionHelper.NotSupported(DeviceTypeEnum.PL241, "DisableRapidReportingEventType")); }
    }

    public Type EnableRapidReportingEventType
    {
      get { throw new NotImplementedException(DeviceHandlerExceptionHelper.NotSupported(DeviceTypeEnum.PL241, "EnableRapidReportingEventType")); }
    }
  }
}
