...
{
  public class ServiceViewManagementForMergeTransfer : Activity
  {
    ...
    public override ActivityResult Execute(Inputs inputs)
    {
      ...
      try
      {
        ...
        // No StartDate argument being defined when creating ServiceViews 
        // will transfer the history of the asset.  
        // This is intended during a merge scenario
        createdViews.AddRange(Services.ServiceViews().CreateServiceViewsForAsset(context.Asset.AssetId));
      }
      catch (Exception ex)
      {
