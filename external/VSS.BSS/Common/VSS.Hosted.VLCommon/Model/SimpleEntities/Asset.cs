...
namespace VSS.Hosted.VLCommon
{
    public partial class Asset
    {
        ...
        public virtual AssetMonitoring AssetMonitoring
        {
            get { return _assetMonitoring; }
            set
            {
                if (!ReferenceEquals(_assetMonitoring, value))
                {
                    var previousValue = _assetMonitoring;
                    _assetMonitoring = value;
                    FixupAssetMonitoring(previousValue);
                }
            }
        }
        private AssetMonitoring _assetMonitoring;
        ...
        private void FixupAssetMonitoring(AssetMonitoring previousValue)
        {
            if (previousValue != null && ReferenceEquals(previousValue.Asset, this))
            {
                previousValue.Asset = null;
            ...
            if (AssetMonitoring != null)
            {
                AssetMonitoring.Asset = this;
            }
        }
