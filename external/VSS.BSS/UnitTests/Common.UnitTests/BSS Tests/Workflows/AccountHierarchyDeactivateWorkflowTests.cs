...
{
  [TestClass]
  public class AccountHierarchyDeactivateWorkflowTests : BssUnitTestBase
  {
    ...
    public void Dealer_Success()
    {
      ...
      var dealer = Entity.Customer.Dealer.BssId(bssId).Save();

      var message = BSS.AHDeactivated.ForDealer().BssId(bssId).Build();
      ...
      Assert.IsFalse(newDealer.IsActivated, "IsActivated");
    }

    [DatabaseTest]
    [TestMethod]
    public void Dealer_Currently_Inactive_SuccessWithWarning()
    {
      var bssId = IdGen.GetId().ToString();
      var customer = Entity.Customer.EndCustomer.BssId(bssId).Save();
      ...
      StringAssert.Contains(warning.Summary, "inactive");
    }
    ...
    public void Customer_Success()
    {
      ...
      Assert.IsTrue(result.Success, "Success");
      Assert.IsFalse(newCustomer.IsActivated, "IsActivated");
    }

    ////[DatabaseTest]
    ////[TestMethod]
    ////public void AccountHierarchy_Deactivate_Success()
    ////{
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_Deactivate_BSSIDNotExists_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_Deactivate_ParentBSSIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_Deactivate_RelationshipIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_ExistingCustomerDeactivate_ParentBSSIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_ExistingCustomerDeactivate_RelationshipIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_ExistingCustomerDeactivate_ParentIDAndRelationshipID_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_ExistingCustomerDeactivate_ContactDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_NewCustomerDeactivate_ContactDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_NewCustomerDeactivate_ParentIDAndRelationshipIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_ExistingCustomerDeactivate_ParentIDRelationshipIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_ExistingCustomerDeactivate_ContactParentIDRelationshipIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
    ...
    //[DatabaseTest]
    //[TestMethod]
    //public void AccountHierarchy_NewCustomerDeactivate_ContactParentIDRelationshipIDDefined_Failure()
    //{
    //  foreach (DealerNetworkEnum item in Enum.GetValues(typeof(DealerNetworkEnum)))
    //  {
    //    foreach (AccountHierarchy.BSSCustomerTypeEnum customerType in Enum.GetValues(typeof(AccountHierarchy.BSSCustomerTypeEnum)))
