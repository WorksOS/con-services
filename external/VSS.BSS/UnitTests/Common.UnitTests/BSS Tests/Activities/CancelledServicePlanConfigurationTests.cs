...
{
  [TestClass]
  public class CancelledServicePlanConfigurationTests : BssUnitTestBase
  {
    CancelledServicePlanConfiguration activity;
    Inputs inputs;
    ...
    {
      activity = new CancelledServicePlanConfiguration();
      inputs = new Inputs();
    ...
    public void Execute_ServicePlanConfigure_Success()
    {
      ...
      StringAssert.Contains(result.Summary, string.Format(CancelledServicePlanConfiguration.SUCCESS_MESSAGE, context.ExistingDeviceAsset.AssetId), "Summary should match.");
    }
    ...
    public void Execute_ServicePlanConfigure_Error()
    {
      ...
      StringAssert.Contains(result.Summary, CancelledServicePlanConfiguration.RETURNED_FALSE_MESSAGE, "Summary should match.");
    }
    ...
    public void Execute_ServicePlanConfigure_Exception()
    {
      ...
      StringAssert.Contains(result.Summary, string.Format(CancelledServicePlanConfiguration.EXCEPTION_MESSAGE, context.ExistingDeviceAsset.AssetId), "Summary should match.");
    }
  }
}