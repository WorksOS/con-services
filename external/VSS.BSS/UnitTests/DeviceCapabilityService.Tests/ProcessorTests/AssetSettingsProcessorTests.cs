...
{
  [TestClass]
  public class AssetSettingsProcessorTests
  {
    [TestMethod]
    public void Test_ForA5N2_Success()
    {
      ...
      AssetSettingsProcessor processor = new AssetSettingsProcessor(_mockStorage.Object, _mockDeviceHandlerParameters.Object, _mockDeviceQueryHelper.Object);

      var device = new Mock<IDeviceQuery>();
      device.SetupGet(e => e.ID).Returns(123);

      IFactoryOutboundEventTypeDescriptor factoryTypeDescriptor = processor.GetAssetIdConfigurationChangedEvent(device.Object);
      Assert.IsTrue(factoryTypeDescriptor.AssemblyQualifiedName.Contains("VSS.Nighthawk.DataOut.Interfaces.Events.IAssetIdConfigurationChangedEvent"));
    ...
    public void Test_ForUnsupportedDevice_ThrowsException()
    {
      ...
      IEnumerable<EndpointDescriptor> expectedEndpointDescriptors = GetTestEndpointDescriptors();
      _mockDeviceQueryHelper.Setup(o => o.GetDeviceType(It.IsAny<IDeviceQuery>(), _mockStorage.Object)).Returns(DeviceTypeEnum.Series523);
      ...
      try
      {
        processor.GetAssetIdConfigurationChangedEvent(device.Object);
    ...
    {
      IDictionary<DeviceTypeEnum, IDeviceHandlerStrategy> handlers = new Dictionary<DeviceTypeEnum, IDeviceHandlerStrategy>();
      handlers.Add(DeviceTypeEnum.Series523, new Series523DeviceHandler(null));
      return handlers;
    }
  }
}
