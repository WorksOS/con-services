...
namespace VSS.Hosted.VLCommon
{
    public partial class CustomerReference
    {
        ...
        {
            if (previousValue != null && previousValue.CustomerReference.Contains(this))
            {
                previousValue.CustomerReference.Remove(this);
            }
    
            if (Store != null)
            {
                if (!Store.CustomerReference.Contains(this))
                {
                    Store.CustomerReference.Add(this);
                }
