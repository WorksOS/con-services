...
namespace VSS.Hosted.VLCommon
{
    public partial class ServiceReference
    {
        ...
        {
            if (previousValue != null && previousValue.ServiceReference.Contains(this))
            {
                previousValue.ServiceReference.Remove(this);
            }
    
            if (Store != null)
            {
                if (!Store.ServiceReference.Contains(this))
                {
                    Store.ServiceReference.Add(this);
                }
