...
namespace VSS.Map3D.Common
{
  ...
  public struct BoundingSphere : IEquatable<BoundingSphere>
  {
    ...
    public ContainmentType Contains(BoundingRect box)
    {
    ...
    public void Contains(ref BoundingRect box, out ContainmentType result)
    {
    ...
    public static BoundingSphere CreateFromBoundingBox(BoundingRect box)
    {
    ...
    public static void CreateFromBoundingBox(ref BoundingRect box, out BoundingSphere result)
    {
    ...
    public bool Intersects(BoundingRect box)
    {
      return box.Intersects(this);
    }

    public void Intersects(ref BoundingRect box, out bool result)
    {
