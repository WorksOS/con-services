...
/// <summary>
/// Developer only utility used to test Megalodon server
/// </summary>
namespace MegalodonClient
{
  public partial class Form1 : Form
  {
    ...
    private void BtnRunSim_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        while (keepGoing & epochCount < epochLimit)
        {
          ...
          lblStatus.Text = $"Epochs:{epochCount}, Passcount:{passCount}, NorthStep:{north}, EastStep:{east}, Heading:{ dir}, Hgt:{currrentHgt}";
    ...
    {
      txtStartHgt.Text = "-6.0";
      cboType.Text = "HEX";
      txtLE.Text = "1576500.0";
      txtLN.Text = "5177505.0";
      txtRE.Text = "1576500.0";
      txtRN.Text = "5177503.0";
      txtLat.Text = "-43.555278";
      txtLong.Text = "172.709705";
      txtEast.Text = "1.0";
    ...
    private void btnGoNorth_Click(object sender, EventArgs e)
    {
      ...
      cboType.Text = "HEX";
      txtLE.Text = "1576500.0";
      txtLN.Text = "5177515.0";
      txtRE.Text = "1576502.0";
      txtRN.Text = "5177515.0";
      txtLat.Text = "-43.555278";
      txtLong.Text = "172.709705";
      txtEast.Text = "0.0";
      txtNorth.Text = "1.0";
