    ...
    public bool Execute()
    {
      ...
      try
      {
        ...
        processor = new PipelineProcessor(requestDescriptor: RequestDescriptor,
          ...
          requireSurveyedSurfaceInformation: Rendering.Utilities.DisplayModeRequireSurveyedSurfaceInformation(Mode) && Rendering.Utilities.FilterRequireSurveyedSurfaceInformation(Filters),
