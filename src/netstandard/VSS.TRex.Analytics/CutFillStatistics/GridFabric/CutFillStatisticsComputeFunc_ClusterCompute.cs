...
namespace VSS.TRex.Analytics.CutFillStatistics.GridFabric
{
  ...
  /// </summary>
  public class CutFillStatisticsComputeFunc_ClusterCompute : AnalyticsComputeFunc_ClusterCompute<CutFillStatisticsArgument, CutFillStatisticsResponse, CutFillStatisticsCoordinator>
  {
  }
}
