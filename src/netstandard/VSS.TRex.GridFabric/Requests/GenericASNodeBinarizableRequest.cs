...
namespace VSS.TRex.GridFabric.Requests
{
  ...
  public abstract class GenericASNodeBinarizableRequest<TArgument, TComputeFunc, TResponse> : ApplicationServicePoolBinarizableRequest<TArgument, TResponse>, IGenericASNodeRequest<TArgument, TResponse>
    where TComputeFunc : IComputeFunc<TArgument, TResponse>, new()
    where TResponse : class, new()
  {
    public GenericASNodeBinarizableRequest(string gridName, string role) : base(gridName, role)
    {
    }
