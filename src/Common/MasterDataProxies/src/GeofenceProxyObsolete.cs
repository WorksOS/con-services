...
//  /// </summary>
//  public class GeofenceProxyObsolete : BaseProxy, IGeofenceProxyObsolete
//  {
//    public GeofenceProxyObsolete(IConfigurationStore configurationStore, ILoggerFactory logger, IDataCache cache) : base(
