// there is no longer a UP service available to ccss. May be in future
...
//{
//  public interface IGeofenceProxyObsolete : ICacheProxy
//  {
...
//    Task<GeofenceData> GetFavoriteGeofence(string customerUid, string userId, string geofenceUid,
//      IDictionary<string, string> customHeaders = null);
