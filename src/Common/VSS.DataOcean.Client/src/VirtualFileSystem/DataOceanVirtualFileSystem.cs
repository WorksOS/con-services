...
namespace VSS.DataOcean.Client.VirtualFileSystem
{
  public class DataOceanVirtualFileSystem : BaseVirtualFileSystem
  {
    public DataOceanVirtualFileSystem(ILoggerFactory loggerFactory) : base(loggerFactory)
    {
    }
