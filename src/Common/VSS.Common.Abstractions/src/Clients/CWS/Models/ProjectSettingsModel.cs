...
{
  public class ProjectSettingsModel : IMasterDataModel
  {
    private string _projectTrn;
    //Note: There are other properties returned but we only want some of it e.g. centroid and area
    //      This is as returned from get project.
    //         projectDetails from other calls may be different.
