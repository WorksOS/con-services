  ...
  public class JobFactoryTests
  {
    ...
    public void TestInitialize()
    {
      ...
      serviceProvider = serviceCollection.AddLogging()
                                         ...
                                         .AddSingleton<IJobRegistrationManager, JobRegistrationManager>()
    ...
    {
      var factory = serviceProvider.GetService<IJobRegistrationManager>();
    ...
    public void CanGetJob()
    {
      ...
      var job = serviceProvider.GetService<IJobFactory>().GetJob(id);
    ...
    public void InvalidJobThrowsError()
    {
      ...
      var jobRegistered = serviceProvider.GetService<IJobFactory>().GetJob(id);
