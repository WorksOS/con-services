...
Invoke-Expression "dotnet publish ./src/VSS.Productivity3D.Scheduler.WebApi/VSS.Productivity3D.Scheduler.WebApi.csproj --configuration Release --output ./build/artifacts/WebApi --framework netcoreapp3.1 --runtime linux-x64 -nowarn:NU1701 -nowarn:CS1591"
...
Copy-Item ./src/VSS.Productivity3D.Scheduler.WebApi/appsettings.json ./build/artifacts/WebApi
Copy-Item ./src/VSS.Productivity3D.Scheduler.WebApi/Dockerfile ./build/artifacts/WebApi
Write-Host "Done"
