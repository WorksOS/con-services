...
#pragma warning restore 1570
  ...
  public class PatchSimpleListResult : ContractExecutionResult
  {
    protected PatchSimpleListResult()
    { }
    ...
    /// Static constructor.
    /// </summary>
    public static PatchSimpleListResult Create(double cellSize, int numCellsInPatch, int totalNumPatchesRequired, PatchCellSimpleResult[] cells)
    {
      return new PatchSimpleListResult
      {
        CellSize = cellSize,
