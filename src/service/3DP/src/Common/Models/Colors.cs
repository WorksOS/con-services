namespace VSS.Productivity3D.Common.Models
{
  ...
  public static class Colors
  {
    ...
    public const uint LtGray = 0xC0C0C0;
    ...
    public const uint None = 0x1FFFFFF;

    public const uint RedGreenTransition = 0xFF8080;
    public const uint BlueGreenTransition = 0x8080FF;
  }
}