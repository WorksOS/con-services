...
# (Aaron) Commented out until we understand why this is failing 50% of the time on Raptor.
#| BoundaryFilterCMVD | ff91dd40-1569-4765-a2bc-014321f76ace | a37f3008-65e5-44a8-b406-9a078ec62ece | 36.206883952552914, -115.0203323364258, 36.207160975535146, -115.01998901367188 | 256   | 256    | 1    | BoundaryFilterCMVD | 3          | 200      |
  ...
  | BoundaryFilterSPD  | ff91dd40-1569-4765-a2bc-014321f76ace | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 36.207160975535146, -115.01930236816406, 36.20771501855802, -115.01861572265624 | 256   | 256    | 26   | BoundaryFilterSPD  | 6          | 200      |
...
Scenario Outline: Get CutFill Tiles
  ...
  | SVGroundToGround3AdjustBaseFilter | ff91dd40-1569-4765-a2bc-014321f76ace | 9244d3f1-af2b-41ed-aa16-5a776278b6eb |                                      | 36.20700097553514, -115.0199023681640, 36.20741501855802, -115.01881572265624   | 256   | 256    | 8    | GroundToGround | 279ed62b-06a2-4184-ab14-dd7462dcc8c1 | 9244d3f1-af2b-41ed-aa16-5a776278b6eb | SummaryVolGroundGround3    | 7          | 200      |
  | GDEarliestWithPCRange             | ff91dd40-1569-4765-a2bc-014321f76ace | 9c27697f-ea6d-478a-a168-ed20d6cd9a20 |                                      | 36.20660692859012, -115.0213623046875, 36.20882309283712, -115.01861572265624   | 256   | 256    | 8    | GroundToDesign | dd64fe2e-6f27-4a78-82a3-0c0e8a5e84ff | 5a130d7c-a79b-433d-a04a-094b07cfc1dd | GDEarliestWithPCRange      | 7          | 200      |
 # (Alan) working locally so need to revisit | DGLatestWithPCRange               | ff91dd40-1569-4765-a2bc-014321f76ace | 9c27697f-ea6d-478a-a168-ed20d6cd9a20 |                                      | 36.20660692859012, -115.0213623046875, 36.20882309283712, -115.01861572265624   | 256   | 256    | 8    | DesignToGround | b06996e4-4944-4d84-b2c7-e1808dd7d7d7 | dd64fe2e-6f27-4a78-82a3-0c0e8a5e84ff | DGLatestWithPCRange        | 5          | 200      |
