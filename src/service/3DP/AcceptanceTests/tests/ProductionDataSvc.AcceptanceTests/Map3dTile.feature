...
Scenario Outline: Get Heightmap with no design filter for all modes
  ...
  | PassCount Mode Request | HeightMapNoFilter | ff91dd40-1569-4765-a2bc-014321f76ace | 36.2063171248096,-115.021142444626,36.2083428474075,-115.017457089439 | 256   | 256    | 4    | 0    | 6          | 200      |
