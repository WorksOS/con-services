...
namespace VSS.Hydrology.WebApi.Abstractions.ResultsHandling
{
  public class HydroErrorCodesProvider : ContractExecutionStatesEnum
  {
    public HydroErrorCodesProvider()
    {
      ...
      DynamicAddwithOffset("Resolution must be between 0.5 and 20.", 4);
      ...
      DynamicAddwithOffset("Levels must be between 2 and 20.", 8);
      ...
      DynamicAddwithOffset("MinSlope must be between 0.005 and 99.0.", 18);
      DynamicAddwithOffset("MaxSlope must be between 0.006 and 100.0.", 19);
