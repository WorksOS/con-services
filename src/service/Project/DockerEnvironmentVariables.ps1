...
[Environment]::SetEnvironmentVariable("TREX_IMPORTFILE_WRITE_API_URL", "http://mockprojectwebapi:55650/api/v1/design", "Machine")
[Environment]::SetEnvironmentVariable("TREX_IMPORTFILE_READ_API_URL", "http://mockprojectwebapi:55750/api/v1/design/get", "Machine")
