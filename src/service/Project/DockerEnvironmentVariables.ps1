...
[Environment]::SetEnvironmentVariable("TREX_IMPORTFILE_API_URL", "http://mockprojectwebapi:5001/api/v1", "Machine")
[Environment]::SetEnvironmentVariable("FILTER_API_URL", "http://mockprojectwebapi:5001", "Machine")
