...
[Environment]::SetEnvironmentVariable("DISSOCIATESUBSPROJECT_API_URL", "http://localhost:5001/dummy/", "Machine")
...
[Environment]::SetEnvironmentVariable("TCCBASEURL", "http://localhost:5001", "Machine")
...
[Environment]::SetEnvironmentVariable("DATA_OCEAN_URL", "http://localhost:5001", "Machine")
...
[Environment]::SetEnvironmentVariable("DATA_OCEAN_ROOT_FOLDER", "dev", "Machine")
[Environment]::SetEnvironmentVariable("MOCK_WEBAPI_BASE_URL", "http://localhost:5001", "Machine")
