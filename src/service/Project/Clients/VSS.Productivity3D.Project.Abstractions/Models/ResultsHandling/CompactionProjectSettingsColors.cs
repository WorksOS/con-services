...
namespace VSS.Productivity3D.Project.Abstractions.Models.ResultsHandling
{
  ...
  /// </summary>
  public class CompactionProjectSettingsColors : IValidatable, IDefaultSettings
  {
    #region Properties
    ...
    /// Default constructor
    /// </summary>
    public CompactionProjectSettingsColors()
    {
    }
    ...
    {
      this.useDefaultElevationColors = useDefaultElevationColors;
      this.elevationColors = elevationColors;
      this.useDefaultCMVDetailsColors = useDefaultCMVDetailsColors;
      this.cmvDetailsColors = cmvDetailsColors;
      this.useDefaultCMVSummaryColors = useDefaultCMVSummaryColors;
      this.cmvOnTargetColor = cmvOnTargetColor;
      this.cmvOverTargetColor = cmvOverTargetColor;
      this.cmvUnderTargetColor = cmvUnderTargetColor;
      this.useDefaultCMVPercentColors = useDefaultCMVPercentColors;
      this.cmvPercentColors = cmvPercentColors;
      this.useDefaultPassCountDetailsColors = useDefaultPassCountDetailsColors;
      this.passCountDetailsColors = passCountDetailsColors;
      this.useDefaultPassCountSummaryColors = useDefaultPassCountSummaryColors;
      this.passCountOnTargetColor = passCountOnTargetColor;
      this.passCountOverTargetColor = passCountOverTargetColor;
      this.passCountUnderTargetColor = passCountUnderTargetColor;
      this.useDefaultCutFillColors = useDefaultCutFillColors;
      this.cutFillColors = cutFillColors;
      this.useDefaultTemperatureDetailsColors = useDefaultTemperatureDetailsColors;
      this.temperatureDetailsColors = temperatureDetailsColors;
      this.useDefaultTemperatureSummaryColors = useDefaultTemperatureSummaryColors;
      this.temperatureOnTargetColor = temperatureOnTargetColor;
      this.temperatureOverTargetColor = temperatureOverTargetColor;
      this.temperatureUnderTargetColor = temperatureUnderTargetColor;
      this.useDefaultSpeedSummaryColors = useDefaultSpeedSummaryColors;
      this.speedOnTargetColor = speedOnTargetColor;
      this.speedOverTargetColor = speedOverTargetColor;
      this.speedUnderTargetColor = speedUnderTargetColor;
      this.useDefaultMDPSummaryColors = useDefaultMDPSummaryColors;
      this.mdpOnTargetColor = mdpOnTargetColor;
      this.mdpOverTargetColor = mdpOverTargetColor;
      this.mdpUnderTargetColor = mdpUnderTargetColor;
    }

    public static CompactionProjectSettingsColors DefaultSettings => new CompactionProjectSettingsColors
    (
    ...
    {
      this.useDefaultElevationColors = DefaultSettings.useDefaultElevationColors;
      this.elevationColors = DefaultSettings.elevationColors;
      this.useDefaultCMVDetailsColors = DefaultSettings.useDefaultCMVDetailsColors;
      this.cmvDetailsColors = DefaultSettings.cmvDetailsColors;
      this.useDefaultCMVSummaryColors = DefaultSettings.useDefaultCMVSummaryColors;
      this.cmvOnTargetColor = DefaultSettings.cmvOnTargetColor;
      this.cmvOverTargetColor = DefaultSettings.cmvOverTargetColor;
      this.cmvUnderTargetColor = DefaultSettings.cmvUnderTargetColor;
      this.useDefaultCMVPercentColors = DefaultSettings.useDefaultCMVPercentColors;
      this.cmvPercentColors = DefaultSettings.cmvPercentColors;
      this.useDefaultPassCountDetailsColors = DefaultSettings.useDefaultPassCountDetailsColors;
      this.passCountDetailsColors = DefaultSettings.passCountDetailsColors;
      this.useDefaultPassCountSummaryColors = DefaultSettings.useDefaultPassCountSummaryColors;
      this.passCountOnTargetColor = DefaultSettings.passCountOnTargetColor;
      this.passCountOverTargetColor = DefaultSettings.passCountOverTargetColor;
      this.passCountUnderTargetColor = DefaultSettings.passCountUnderTargetColor;
      this.useDefaultCutFillColors = DefaultSettings.useDefaultCutFillColors;
      this.cutFillColors = DefaultSettings.cutFillColors;
      this.useDefaultTemperatureDetailsColors = DefaultSettings.useDefaultTemperatureDetailsColors;
      this.temperatureDetailsColors = DefaultSettings.temperatureDetailsColors;
      this.useDefaultTemperatureSummaryColors = DefaultSettings.useDefaultTemperatureSummaryColors;
      this.temperatureOnTargetColor = DefaultSettings.temperatureOnTargetColor;
      this.temperatureOverTargetColor = DefaultSettings.temperatureOverTargetColor;
      this.temperatureUnderTargetColor = DefaultSettings.temperatureUnderTargetColor;
      this.useDefaultSpeedSummaryColors = DefaultSettings.useDefaultSpeedSummaryColors;
      this.speedOnTargetColor = DefaultSettings.speedOnTargetColor;
      this.speedOverTargetColor = DefaultSettings.speedOverTargetColor;
      this.speedUnderTargetColor = DefaultSettings.speedUnderTargetColor;
      this.useDefaultMDPSummaryColors = DefaultSettings.useDefaultMDPSummaryColors;
      this.mdpOnTargetColor = DefaultSettings.mdpOnTargetColor;
      this.mdpOverTargetColor = DefaultSettings.mdpOverTargetColor;
      this.mdpUnderTargetColor = DefaultSettings.mdpUnderTargetColor;
    }
    ...
    {
      var validator = new Validation.DataAnnotationsValidator();
