...
namespace VSS.Productivity3D.Project.Proxy
{
  public class ProjectV5Proxy : BaseServiceDiscoveryProxy, IProjectProxy
  {
    ...
    //public Task<ProjectData> GetProject(int shortRaptorProjectId, IDictionary<string, string> customHeaders = null)
    //{
    //  throw new System.NotImplementedException();
    //}
    ...
    //  IDictionary<string, string> customHeaders = null)
    //{
    //  return await GetItemWithRetry<ProjectDataResult, ProjectData>(GetProjects, p => p.shortRaptorProjectId == projectId, customerUid, customHeaders);
    //}
