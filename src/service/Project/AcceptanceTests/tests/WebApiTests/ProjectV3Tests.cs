...
namespace WebApiTests
{
  ...
  public class ProjectV3Tests
  {
    ...
    public void Create_Project_Twice()
    {
      ...
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, "project 2", ts.FirstEventDate, ts.LastEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
    }
    ...
    public void Create_Project_Bad_Data()
    {
      ...
      var projectId = ts.SetLegacyProjectId();
      //No action UTC
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, "project 3", ts.FirstEventDate, ts.LastEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.MinValue, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //No project UID
      ts.CreateProjectViaWebApiV3(Guid.Empty, projectId, "project 3", ts.FirstEventDate, ts.LastEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //No time zone
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, "project 3", ts.FirstEventDate, ts.LastEventDate, null, ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //No project name
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, null, ts.FirstEventDate, ts.LastEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //No start date
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, "project 3", DateTime.MinValue, ts.LastEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //No end date
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, "project 3", ts.FirstEventDate, DateTime.MinValue, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //Bad end date
      //    ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, "project 3", ts.FirstEventDate, ts.FirstEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //Bad date range
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, "project 3", ts.LastEventDate, ts.FirstEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //No legacy project ID
      // ts.CreateProjectViaWebApiV3(ts.ProjectUid, 0, "project 3", ts.FirstEventDate, ts.LastEventDate, "New Zealand Standard Time", ProjectType.Standard, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.BadRequest);
      //No boundary
    ...
    public void Delete_Project_After_Create()
    {
      ...
      ts.DeleteProjectViaWebApiV3(ts.ProjectUid, DateTime.UtcNow, HttpStatusCode.OK);
    ...
    public void Delete_Project_Before_Create()
    {
      ...
      var ts = new TestSupport();
      ts.DeleteProjectViaWebApiV3(ts.ProjectUid, DateTime.UtcNow, HttpStatusCode.BadRequest);
    }
    ...
    public void Delete_Project_Bad_Data()
    {
      ...
      //No project UID
      ts.DeleteProjectViaWebApiV3(Guid.Empty, DateTime.UtcNow, HttpStatusCode.BadRequest);
    }
    ...
    //  ts.AssociateCustomerProjectViaWebApiV3(ts.ProjectUid, ts.CustomerUid, 111111111, DateTime.UtcNow, HttpStatusCode.OK);
    //  mysql.VerifyTestResultDatabaseRecordCount("CustomerProject", "fk_ProjectUID", 1, ts.ProjectUid);
    //  ts.DissociateProjectViaWebApiV3(ts.ProjectUid, ts.CustomerUid, DateTime.UtcNow, HttpStatusCode.NotImplemented);
    ...
    //  //   var projectId = ts.SetLegacyProjectId();
    //  //No action UTC
    //  ts.DissociateProjectViaWebApiV3(ts.ProjectUid, ts.CustomerUid, DateTime.MinValue, HttpStatusCode.BadRequest);
    //  //No project UID
    //  ts.DissociateProjectViaWebApiV3(Guid.Empty, ts.CustomerUid, DateTime.UtcNow, HttpStatusCode.BadRequest);
    //  //No customer UID
    //  ts.DissociateProjectViaWebApiV3(ts.ProjectUid, Guid.Empty, DateTime.UtcNow, HttpStatusCode.NotImplemented);
    //}
    ...
    public void Get_Projects_With_Deleted_Projects()
    {
      ...
      ts.DeleteProjectViaWebApiV3(projectUid1, DateTime.UtcNow, HttpStatusCode.OK);
    ...
    {
      ts.CreateProjectViaWebApiV3(ts.ProjectUid, projectId, projectName, ts.FirstEventDate, ts.LastEventDate, "New Zealand Standard Time", projectType, DateTime.UtcNow, PROJECT_BOUNDARY, HttpStatusCode.OK);
