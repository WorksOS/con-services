...
{
  public class ProjectV4ServiceDiscoveryProxy : BaseServiceDiscoveryProxy, IProjectProxy
  {
    public ProjectV4ServiceDiscoveryProxy(IWebRequest webRequest, IConfigurationStore configurationStore, ILoggerFactory logger, IDataCache dataCache, IServiceResolution serviceResolution) 
