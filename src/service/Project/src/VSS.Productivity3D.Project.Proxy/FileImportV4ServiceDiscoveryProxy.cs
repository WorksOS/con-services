...
{
  public class FileImportV4ServiceDiscoveryProxy : BaseServiceDiscoveryProxy, IFileImportProxy
  {
    public FileImportV4ServiceDiscoveryProxy(IWebRequest webRequest, IConfigurationStore configurationStore, ILoggerFactory logger, IDataCache dataCache, IServiceResolution serviceResolution)
