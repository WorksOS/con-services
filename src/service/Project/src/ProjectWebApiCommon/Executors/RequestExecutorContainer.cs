...
namespace VSS.MasterData.Project.WebAPI.Common.Executors
{
  ...
  public abstract class RequestExecutorContainer
  {
    ...
    {
      var project = (await ProjectRequestHelper.GetProjectListForCustomer(new Guid(customerUid), new Guid(userId), log, serviceExceptionHandler, cwsProjectClient, null, null, customHeaders).ConfigureAwait(false))
