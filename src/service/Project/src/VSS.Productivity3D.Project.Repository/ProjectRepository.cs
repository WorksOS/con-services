<<<<<<< HEAD:src/Common/MasterDataRepositories/src/ProjectRepository.cs
﻿using System;
...
namespace VSS.MasterData.Repositories
{
  public class ProjectRepository : RepositoryBase, IRepository<IProjectEvent>, IProjectRepository
  {
    ...
    private async Task UpsertProjectTypeGeofence(string upsertType, Project project)
    {
    ...
    private async Task<int> UpdateGeofence(Project project, Geofence existingGeofence)
    {
...
>>>>>>> 710149bedba43cf697c287439e7b9893d8e355b9:src/service/Project/src/VSS.Productivity3D.Project.Repository/ProjectRepository.cs
