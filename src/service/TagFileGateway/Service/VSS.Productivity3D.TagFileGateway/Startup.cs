...
using VSS.Productivity3D.TagFileGateway.Common;
...
{
  /// <summary>
  /// VSS.Productivity3D.TagFileForwarder application startup.
  /// </summary>
  public class Startup : BaseStartup
  {
    ...
    protected override void ConfigureAdditionalServices(IServiceCollection services)
    {
      ...
      services.AddScoped<IErrorCodesProvider, TagFileForwarderExecutionStates>();
      services.AddSingleton<ITagFileForwarder, TagFileForwarderProxy>();
      services.AddHostedService<TagFileProcessingService>();
