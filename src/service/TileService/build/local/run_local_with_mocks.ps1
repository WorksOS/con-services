...
docker run -d -p 5001:5001 940327799086.dkr.ecr.us-west-2.amazonaws.com/rpd-ccss-mock-webapi:latest-linux
docker run -d -p 80:80 --env-file .\mocks.env 940327799086.dkr.ecr.us-west-2.amazonaws.com/rpd-ccss-tile-webapi:latest
