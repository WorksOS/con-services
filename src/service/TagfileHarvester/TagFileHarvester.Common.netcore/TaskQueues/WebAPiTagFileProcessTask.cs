    ...
    public TagFileSplitterAutoResponse ProcessTagfile(string tagFilename, Organization org)
    {
      ...
      try
      {
        ...
        finally
        {
          ...
          vssTargetServiceResponse = result.TargetServiceResponses.First(r => string.Compare(r.ServiceName, OrgsHandler.VssServiceName, StringComparison.InvariantCultureIgnoreCase) == 0);
        }
