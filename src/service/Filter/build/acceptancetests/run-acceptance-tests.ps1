...
Invoke-Expression "dotnet publish ./src/VSS.Productivity3D.Filter.WebApi/VSS.Productivity3D.Filter.WebApi.csproj --configuration Release --output ./build/artifacts/Filter --framework netcoreapp3.1 --runtime linux-x64 -nowarn:NU1701 -nowarn:CS1591"
...
Copy-Item ./src/VSS.Productivity3D.Filter.WebApi/appsettings.json ./build/artifacts/Filter
Copy-Item ./src/VSS.Productivity3D.Filter.WebApi/Dockerfile ./build/artifacts/Filter
Copy-Item ./src/VSS.Productivity3D.Filter.WebApi/web.config ./build/artifacts/Filter
Write-Host "Done"
...
Invoke-Expression "dotnet publish ./tests/ExecutorTests/ExecutorTests.csproj -o ./deploy/ExecutorTests -f netcoreapp3.1 -nowarn:NU1701 -nowarn:CS1591"
Invoke-Expression "dotnet publish ./tests/RepositoryTests/RepositoryTests.csproj -o ./deploy/RepositoryTests -f netcoreapp3.1 -nowarn:NU1701 -nowarn:CS1591"
Invoke-Expression "dotnet publish ./tests/WebApiTests/WebApiTests.csproj -o ./deploy/WebApiTests -f netcoreapp3.1 -nowarn:NU1701 -nowarn:CS1591"
