...
namespace RepositoryTests
{
  ...
  public class RepositoryTests : TestControllerBase
  {
    ...
    public void GeofenceSchemaExists()
    {
      ...
      List<string> columnNames = new List<string>
      {
        "ID", "GeofenceUID", "Name" , "fk_GeofenceTypeID", "OldGeometryWKT", "PolygonST", "FillColor", "IsTransparent", "IsDeleted", "Description", "AreaSqMeters", "fk_CustomerUID", "UserUID", "LastActionedUTC", "InsertUTC", "UpdateUTC"
      };
      CheckSchema(tableName, columnNames);
    }
