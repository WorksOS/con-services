...
namespace ExecutorTests
{
  ...
  public class UpsertBoundaryExecutorTests : BoundaryRepositoryBase
  {
    ...
    public async Task UpsertBoundaryExecutor_NoExistingBoundary()
    {
      ...
      var executor = RequestExecutorContainer.Build<UpsertBoundaryExecutor>(ConfigStore, Logger, ServiceExceptionHandler, GeofenceRepo, ProjectRepo, ProjectProxy, RaptorProxy, AssetResolverProxy, Producer, KafkaTopicName);
