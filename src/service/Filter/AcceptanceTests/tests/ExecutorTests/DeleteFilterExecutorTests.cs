...
namespace ExecutorTests
{
  ...
  public class DeleteFilterExecutorTests : FilterRepositoryBase
  {
    ...
    public async Task DeleteFilterExecutor_NoExistingFilter(FilterType filterType)
    {
      ...
      var executor =
        RequestExecutorContainer.Build<DeleteFilterExecutor>(ConfigStore, Logger, ServiceExceptionHandler, FilterRepo, null, ProjectListProxy, RaptorProxy, AssetResolverProxy, Producer, KafkaTopicName);
