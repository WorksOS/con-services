...
namespace ExecutorTests
{
  ...
  public class DeleteFilterExecutorTests : FilterRepositoryBase
  {
    ...
    public async Task DeleteFilterExecutor_NoExistingFilter(FilterType filterType)
    {
      ...
      var executor =
        RequestExecutorContainer.Build<DeleteFilterExecutor>(ConfigStore, Logger, ServiceExceptionHandler, FilterRepo, null, ProjectProxy, Productivity3DProxy, Producer, KafkaTopicName);
