...
Invoke-Expression "dotnet publish ./src/CCSS.Productivity3D.Preferences.WebApi/CCSS.Productivity3D.Preferences.WebApi.csproj --configuration Release --output ./build/artifacts/WebApi --framework netcoreapp3.1 --runtime linux-x64 -nowarn:NU1701 -nowarn:CS1591"
...
Copy-Item ./src/CCSS.Productivity3D.Preferences.WebApi/appsettings.json ./build/artifacts/WebApi
Copy-Item ./src/CCSS.Productivity3D.Preferences.WebApi/Dockerfile ./build/artifacts/WebApi
Write-Host "Done"
