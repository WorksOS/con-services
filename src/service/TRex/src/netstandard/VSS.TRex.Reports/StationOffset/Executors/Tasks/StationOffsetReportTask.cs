...
namespace VSS.TRex.Reports.StationOffset.Executors.Tasks
{
  /// <summary>
  /// The task responsible for receiving subgrids to be aggregated into a grid response
  /// </summary>
  public class StationOffsetReportTask : PipelinedSubGridTask
  {
    ...
    public StationOffsetReportTask()
    {
    }
    ...
    public StationOffsetReportTask(Guid requestDescriptor, string tRexNodeId, GridDataType gridDataType) : base(requestDescriptor, tRexNodeId, gridDataType)
    {
    }
