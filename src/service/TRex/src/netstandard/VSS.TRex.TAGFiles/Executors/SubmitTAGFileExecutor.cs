...
namespace VSS.TRex.TAGFiles.Executors
{
  ...
  public class SubmitTAGFileExecutor
  {
    ...
    private static readonly bool _tagFileArchiving = true; //  DIContext.Obtain<IConfigurationStore>().GetValueBool("ENABLE_TAGFILE_ARCHIVING", Consts.ENABLE_TAGFILE_ARCHIVING);
