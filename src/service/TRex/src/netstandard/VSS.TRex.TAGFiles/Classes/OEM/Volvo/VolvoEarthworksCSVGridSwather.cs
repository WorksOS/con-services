...
namespace VSS.TRex.TAGFiles.Classes.OEM.Volvo
{
  public class VolvoEarthworksCSVGridSwather : SwatherBase
    {
      private static readonly ILogger Log = Logging.Logger.CreateLogger<VolvoEarthworksCSVGridSwather>();
      ...
      public bool SwathSingleCell(double cellCenterX, double cellCenterY, double cellWidth, VolvoEarthworksCSVRecord cellPass)
      {
