...
namespace VSS.TRex.Designs.Interfaces
{
  public interface IDesignBase
  {
    ...
    Task<DesignLoadResult> LoadFromStorage(Guid siteModelUid, string fileName, string localPath, bool loadIndices = false);
    void RemoveFromStorage(Guid siteModelUid, string fileName);
