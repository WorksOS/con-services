...
namespace VSS.TRex.Analytics.SpeedStatistics.GridFabric
{
	...
	/// </summary>
  public class SpeedStatisticsComputeFunc_ClusterCompute : AnalyticsComputeFunc_ClusterCompute<SpeedStatisticsArgument, SpeedStatisticsResponse, SpeedStatisticsCoordinator>
	{
  }
}
