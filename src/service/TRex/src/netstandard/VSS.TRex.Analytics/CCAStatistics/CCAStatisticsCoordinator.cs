...
{
  /// <summary>
  /// Computes CCA statistics. Executes in the 'application service' layer and acts as the coordinator
  ...
  public class CCAStatisticsCoordinator : BaseAnalyticsCoordinator<CCAStatisticsArgument, CCAStatisticsResponse>
  {
    ...
    /// <summary>
    /// Constructs the computor from the supplied argument and aggregator for the CCA statistics analytics request
    /// </summary>
    /// <param name="argument"></param>
    ...
    /// <summary>
    /// Pull the required counts information from the internal CCA statistics aggregator state
    /// </summary>
    /// <param name="aggregator"></param>
    /// <param name="response"></param>
    public override void ReadOutResults(AggregatorBase aggregator, CCAStatisticsResponse response)
    {
      ...
      response.LastTargetCCA = ((CCAStatisticsAggregator)aggregator).LastTargetCCA;
    }
  }
}
