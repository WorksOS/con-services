...
namespace VSS.TRex.Profiling
{
  ...
  /// </summary>
    ...
    /// of layers over and over again
      ...
      /// <returns></returns>
      public int Add(IProfileLayer value, int layerRecycledIndex)
      {
        int result;
      ...
      /// <param name="value"></param>
      /// <returns></returns>
      public new int Add(IProfileLayer value)
      {
      ...
      /// </summary>
      /// <returns></returns>
      public IProfileLayer Last() => this[InternalCount - 1];
      ...
      /// <param name="layerRecycledIndex"></param>
      /// <returns></returns>
      public IProfileLayer GetRecycledLayer(out int layerRecycledIndex)
      {
