...
namespace VSS.TRex.GridFabric.Affinity
{
  ...
  public class AffinityFunctionBase : IAffinityFunction
  {
    ...
    protected static readonly uint NumPartitions = DIContext.Obtain<IConfigurationStore>().GetValueUint("NUMPARTITIONS_PERDATACACHE", Consts.NUMPARTITIONS_PERDATACACHE);
