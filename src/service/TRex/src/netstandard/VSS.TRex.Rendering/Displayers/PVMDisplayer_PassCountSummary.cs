...
namespace VSS.TRex.Rendering.Displayers
{
  ...
  /// </summary>
  public class PVMDisplayer_PassCountSummary : PVMDisplayerBase<PassCountSummaryPalette, ClientPassCountLeafSubGrid, SubGridCellPassDataPassCountEntryRecord>
  {
    /// <summary>
