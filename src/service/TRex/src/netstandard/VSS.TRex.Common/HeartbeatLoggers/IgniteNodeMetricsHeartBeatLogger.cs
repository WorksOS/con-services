...
{
  public class IgniteNodeMetricsHeartBeatLogger : IHeartBeatLogger
  {
...
namespace Apache.Ignite.Core.Cluster
{
  ...
  {
    /// <summary>Last update time of this node metrics.</summary>
    ...
    /// <summary>Average number of active jobs.</summary>
    float AverageActiveJobs { get; }

    /// <summary>Maximum number of waiting jobs.</summary>
    ...
    /// <summary>Average number of waiting jobs.</summary>
    float AverageWaitingJobs { get; }

    /// <summary>Maximum number of jobs rejected at once.</summary>
    ...
    /// <summary>Number of cancelled jobs that are still running.</summary>
    int CurrentCancelledJobs { get; }

    /// <summary>Average number of cancelled jobs.</summary>
    float AverageCancelledJobs { get; }

    /// <summary>Total number of cancelled jobs since node startup.</summary>
    ...
    /// <summary>Time it took to execute the longest job on the node.</summary>
    long MaximumJobExecuteTime { get; }

    /// <summary>Longest time a current job has been executing for.</summary>
    long CurrentJobExecuteTime { get; }

    /// <summary>Average job execution time.</summary>
    double AverageJobExecuteTime { get; }

    /// <summary>Total number of jobs handled by the node.</summary>
    int TotalExecutedTasks { get; }

    /// <summary>Total time this node spent executing jobs.</summary>
    long TotalBusyTime { get; }

    /// <summary>Total time this node spent idling.</summary>
    long TotalIdleTime { get; }

    /// <summary>Time this node spend idling since executing last job.</summary>
    long CurrentIdleTime { get; }

    /// <summary>Percentage of time this node is busy.</summary>
    float BusyTimePercentage { get; }

    /// <summary>Percentage of time this node is idle</summary>
    ...
    /// <summary>Returns the CPU usage usage in [0, 1] range.</summary>
    ...
    /// <summary>Average time spent in CG since the last update.</summary>
    ...
    /// <summary>Current non-heap memory size that is used by Java VM.</summary>
    ...
    /// <summary>Uptime of the JVM in milliseconds.</summary>
    long Uptime { get; }

    /// <summary>Start time of the JVM in milliseconds.</summary>
    DateTime StartTime { get; }

    /// <summary>Start time of the Ignite node in milliseconds.</summary>
    DateTime NodeStartTime { get; }

    /// <summary>Current number of live threads.</summary>
    int CurrentThreadCount { get; }

    /// <summary>The peak live thread count.</summary>
    int MaximumThreadCount { get; }

    /// <summary>The total number of threads started.</summary>
    long TotalStartedThreadCount { get; }

    /// <summary>Current number of live daemon threads.</summary>
    ...
    /// <summary>Sent messages count</summary>
    int SentMessagesCount { get; }

    /// <summary>Sent bytes count.</summary>
    long SentBytesCount { get; }

    /// <summary>Received messages count.</summary>
    int ReceivedMessagesCount { get; }

    /// <summary>Received bytes count.</summary>
    long ReceivedBytesCount { get; }

    /// <summary>Outbound messages queue size.</summary>
    int OutboundMessagesQueueSize { get; }

    /// <summary>Gets total number of nodes.</summary>
    int TotalNodes { get; }
  }
}
   */
