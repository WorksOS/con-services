...
{
  /// <summary>
  /// Extension methods supporting serialization and deserialization to and from vanilla byte arrays.
  /// </summary>
  public static class FromToBytes
  {
    ...
    */
    ...
    /// <summary>
    /// An extension method providing a ToStream() semantic to serialize its state to a stream via the class defined Write() implementation
    /// </summary>
    public static byte[] ToBytes<T>(this T item) where T : class, IBinaryReaderWriter => ToBytes(item.Write);

    /// <summary>
    /// An extension method providing a ToBytes() semantic to serialize its state to a byte array via the class defined Write() implementation
    /// </summary>
    public static MemoryStream ToStream<T>(this T item) where T : class, IBinaryReaderWriter => ToStream(item.Write);

    /// <summary>
    /// A generic method providing a ToBytes() semantic to serialize its state to a byte array via the class defined Write() implementation
    /// </summary>
    ...
    /// <summary>
    /// A generic method providing a ToStream() semantic to serialize its state to a stream via the class defined Write() implementation
    /// </summary>
