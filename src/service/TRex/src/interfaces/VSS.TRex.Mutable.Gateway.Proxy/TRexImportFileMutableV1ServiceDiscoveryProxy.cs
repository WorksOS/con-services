...
namespace VSS.TRex.Mutable.Gateway.Proxy
{
  ...
  /// </summary>
  public class TRexImportFileMutableV1ServiceDiscoveryProxy : BaseServiceDiscoveryProxy, ITRexImportFileProxy
  {
    ...
    // todoJeannie TREX_IMPORTFILE_WRITE_API_URL=http://localhost:5001/api/v1/design
    ...
    public TRexImportFileMutableV1ServiceDiscoveryProxy(IWebRequest webRequest, IConfigurationStore configurationStore, ILoggerFactory logger, IDataCache dataCache, IServiceResolution serviceResolution)
    ...
    public override ApiService InternalServiceType => ApiService.TRexMutable;
