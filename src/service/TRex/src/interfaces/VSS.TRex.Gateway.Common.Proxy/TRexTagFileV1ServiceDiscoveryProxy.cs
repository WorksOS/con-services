...
namespace VSS.TRex.Gateway.Common.Proxy
{
  ...
  /// </summary>
  public class TRexTagFileV1ServiceDiscoveryProxy : BaseTRexServiceDiscoveryProxy, ITRexTagFileProxy
  {
    public TRexTagFileV1ServiceDiscoveryProxy(IWebRequest webRequest, IConfigurationStore configurationStore,
