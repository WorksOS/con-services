  ...
  public class LiftParametersProfile : Profile
  {
    public LiftParametersProfile()
    {
      CreateMap<LiftSettings, ILiftParameters>()
        ...
        .ForMember(x => x.CCVSummaryTypes, opt => opt.ResolveUsing(o => ResolveCCVSummaryType(o.CCVSummaryType)))
        .ForMember(x => x.MDPSummaryTypes, opt => opt.ResolveUsing(o => ResolveMDPSummaryType(o.MDPSummaryType)))
