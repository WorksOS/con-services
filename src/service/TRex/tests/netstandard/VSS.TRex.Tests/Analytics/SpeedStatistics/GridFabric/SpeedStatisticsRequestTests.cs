...
namespace VSS.TRex.Tests.Analytics.SpeedStatistics.GridFabric
{
  ...
  public class SpeedStatisticsRequestTests : BaseTests<SpeedStatisticsArgument, SpeedStatisticsResponse>, IClassFixture<DITAGFileAndSubGridRequestsWithIgniteFixture>
  {
    ...
    [Fact]
    public void Test_SummarySpeedStatistics_EmptySiteModel_FullExtents_NoSpeedTargetOverride()
    {
      ...
      var mdpSummaryResult = operation.Execute(SimpleSpeedStatisticsArgument(siteModel, 0, 0));
    ...
    [Fact]
    public void Test_SummarySpeedStatistics_SiteModelWithSingleCell_FullExtents_NoSpeedTargetRange()
    {
      AddClusterComputeGridRouting();
      AddApplicationGridRouting();
      ...
      var speedSummaryResult = operation.Execute(SimpleSpeedStatisticsArgument(siteModel, CellPassConsts.NullMachineSpeed, CellPassConsts.NullMachineSpeed));
    ...
    public void Test_SummarySpeedStatistics_SiteModelWithSingleCell_FullExtents_WithSpeedTargetRange
    ...
    public void Test_SummarySpeedStatistics_SiteModelWithSingleTAGFile_FullExtents_WithSpeedTargetRange
      (ushort minTarget, ushort maxTarget, double percentBelow, double percentWithin, double percentAbove)
    {
      AddClusterComputeGridRouting();
      AddApplicationGridRouting();
      ...
      var cmvSummaryResult = operation.Execute(SimpleSpeedStatisticsArgument(siteModel, minTarget, maxTarget));
