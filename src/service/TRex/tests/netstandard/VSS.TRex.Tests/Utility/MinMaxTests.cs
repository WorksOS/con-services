...
namespace VSS.TRex.Tests.Utility
{
        public class MinMaxTests
    {
        ...
        public void Test_Swap()
        {
            ...
            Common.Utilities.MinMax.Swap(ref a, ref b);
            Assert.True(a == 20 && b == 10, "Swap failed to swap items");

            Common.Utilities.MinMax.Swap<int>(ref a, ref b);
        ...
        public void Test_SetMinMax()
        {
            ...
            Common.Utilities.MinMax.SetMinMax(ref a, ref b);
            Assert.True(a == 10 && b == 20, "SetMinMax swapped values when it should not");

            double c = 20;
            double d = 10;

            Common.Utilities.MinMax.SetMinMax(ref c, ref d);
        ...
        public void Test_SetMinMax_In_T()
        {
            ...
            Common.Utilities.MinMax.SetMinMax<int>(ref a, ref b);
            Assert.True(a == 10 && b == 20, "SetMinMax swapped values when it should not");

            int c = 20;
            int d = 10;

            Common.Utilities.MinMax.SetMinMax<int>(ref c, ref d);
            Assert.True(c == 10 && d == 20, "SetMinMax did not swap values when it should");
        }
    }
}
