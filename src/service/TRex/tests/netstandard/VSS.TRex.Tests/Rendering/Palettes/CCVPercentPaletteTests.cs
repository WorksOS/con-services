...
{
  public class CCVPercentPaletteTests
  {
    ...
    [Fact]
    public void Test_CCVPercentPalette_Creation()
    {
    ...
    [Fact]
    public void Test_CCVPercentPalette_ChooseColour_NullMachineTarget()
    {
      var palette = new CCVPercentPalette();
    ...
    [Fact]
    public void Test_CCVPercentPalette_ChooseColour_OverrideTarget()
    {
      var palette = new CCVPercentPalette();
