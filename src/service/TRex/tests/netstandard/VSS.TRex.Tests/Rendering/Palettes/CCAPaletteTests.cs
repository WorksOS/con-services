...
namespace VSS.TRex.Tests.Rendering.Palettes
{
  public class CCAPaletteTests
  {
    ...
    public void Test_CCAPalette_Creation()
    {
      ...
      palette.PaletteTransitions[5].Color.Should().Be(ColorTranslator.FromHtml("#91C8FF"));
      palette.PaletteTransitions[6].Value.Should().Be(6);
      palette.PaletteTransitions[6].Color.Should().Be(ColorTranslator.FromHtml("#ACFDEB"));
      ...
      palette.PaletteTransitions[8].Color.Should().Be(ColorTranslator.FromHtml("#FFC0FF"));
      palette.PaletteTransitions[9].Value.Should().Be(9);
      palette.PaletteTransitions[9].Color.Should().Be(ColorTranslator.FromHtml("#FFCB96"));
      palette.PaletteTransitions[10].Value.Should().Be(10);
      palette.PaletteTransitions[10].Color.Should().Be(ColorTranslator.FromHtml("#6C8EB5"));
      palette.PaletteTransitions[11].Value.Should().Be(11);
      palette.PaletteTransitions[11].Color.Should().Be(ColorTranslator.FromHtml("#80FFFF"));
      palette.PaletteTransitions[12].Value.Should().Be(12);
      palette.PaletteTransitions[12].Color.Should().Be(ColorTranslator.FromHtml("#8080FF"));
      palette.PaletteTransitions[13].Value.Should().Be(13);
      palette.PaletteTransitions[13].Color.Should().Be(ColorTranslator.FromHtml("#00FF80"));
      palette.PaletteTransitions[14].Value.Should().Be(14);
      palette.PaletteTransitions[14].Color.Should().Be(ColorTranslator.FromHtml("#FF8000"));
      palette.PaletteTransitions[15].Value.Should().Be(15);
      palette.PaletteTransitions[15].Color.Should().Be(ColorTranslator.FromHtml("#8000FF"));
      ...
      palette.PaletteTransitions[17].Color.Should().Be(ColorTranslator.FromHtml("#C0C0FF"));
      palette.PaletteTransitions[18].Value.Should().Be(18);
      palette.PaletteTransitions[18].Color.Should().Be(ColorTranslator.FromHtml("#FF80FF"));

      for (var i = 19; i <= 49; i++)
      {
        palette.PaletteTransitions[i].Value.Should().Be(i);
        palette.PaletteTransitions[i].Color.Should().Be(ColorTranslator.FromHtml("#80FF00"));
      }
    }
