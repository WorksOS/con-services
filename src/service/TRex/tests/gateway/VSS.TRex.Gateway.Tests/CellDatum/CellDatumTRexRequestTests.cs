...
namespace VSS.TRex.Gateway.Tests.CellDatum
{
  public class CellDatumTRexRequestTests
  {
    ...
    {
      var request = new CellDatumTRexRequest(Guid.NewGuid(), DisplayMode.PassCount, new WGSPoint(123.456, 987.654), new Point(123.456, 987.654), null, null, 0, null, null);
      Assert.Throws<ServiceException>(() => request.Validate());
    }
    ...
    {
      var request = new CellDatumTRexRequest(Guid.Empty, DisplayMode.PassCount, new WGSPoint(123.456, 987.654), new Point(123.456, 987.654), null, null, 0, null, null);
      Assert.Throws<ServiceException>(() => request.Validate());
    }
