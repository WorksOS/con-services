...
{
  public class MockRaptorController : BaseController
  {
    public MockRaptorController(ILoggerFactory loggerFactory) : base(loggerFactory)
    { }
      ...
      [FromQuery] string projectSettings)
    {
      ...
      Logger.LogInformation($"DummyValidateProjectSettingsGet: res {res}. projectSettings {projectSettings}");
    ...
    public BaseDataResult DummyValidateProjectSettingsPost([FromBody] ProjectSettingsRequest request)
    {
      ...
      Logger.LogInformation($"DummyValidateProjectSettingsGet: res {res}. projectSettings {request.Settings}");
