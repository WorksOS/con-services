...
{
  public class MockProductivity3dV2CompactionTileController : BaseController
  {
    public MockProductivity3dV2CompactionTileController(ILoggerFactory loggerFactory) : base(loggerFactory)
    { }
