...
docker pull 940327799086.dkr.ecr.us-west-2.amazonaws.com/rpd-ccss-project-webapi:latest
docker pull 940327799086.dkr.ecr.us-west-2.amazonaws.com/rpd-ccss-project-masterdataconsumer:latest
...
-e KAFKA_TOPICS='VSS.Interfaces.Events.MasterData.IProjectEvent' \
 940327799086.dkr.ecr.us-west-2.amazonaws.com/rpd-ccss-project-masterdataconsumer:latest /bin/bash
