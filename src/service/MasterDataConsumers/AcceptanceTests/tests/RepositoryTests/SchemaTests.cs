...
namespace RepositoryTests
{
  ...
  public class SchemaTests : TestControllerBase
  {
    ...
    public void ProjectSchemaExists()
    {
      ...
      List<string> columnNames = new List<string>
          {
            "ProjectUID", "LegacyProjectID", "Name", "Description", "fk_ProjectTypeID", "IsDeleted", "ProjectTimeZone", "LandfillTimeZone", "StartDate", "EndDate", "LastActionedUTC", "InsertUTC", "UpdateUTC", "PolygonST", "CoordinateSystemFileName", "CoordinateSystemLastActionedUTC"
          };
      CheckSchema(tableName, columnNames);
    }
    ...
    public void GeofenceSchemaExists()
    {
      ...
      List<string> columnNames = new List<string>
          {
            "ID", "GeofenceUID", "Name", "fk_GeofenceTypeID", "PolygonST", "FillColor", "IsTransparent", "IsDeleted", "LastActionedUTC", "Description", "AreaSqMeters", "fk_CustomerUID", "UserUID", "InsertUTC", "UpdateUTC"
          };
      CheckSchema(tableName, columnNames);
    }
