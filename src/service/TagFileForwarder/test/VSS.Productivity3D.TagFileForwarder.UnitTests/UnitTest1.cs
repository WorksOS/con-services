...
namespace VSS.Productivity3D.TagFileForwarder.UnitTests
{
  public class UnitTest1
  {
 [TestClass]
  public class TagFileForwarderTests
  {
    ...
    public static void ClassInit(TestContext context)
    {
      _serviceProvider = new ServiceCollection()
        ...
        .AddTransient<ITagFileForwarder, TagFileForwarder>() // Class under test
#if RAPTOR
    ...
    public void TestEnabled()
    {
      ...
      var forwarder = _serviceProvider.GetService<ITagFileForwarder>() as TagFileForwarder;
    ...
    public void TestDirectSuccess()
    {
      ...
      var forwarder = new Mock<TagFileForwarder>(_mockStore.Object, _logger) {CallBase = true};
