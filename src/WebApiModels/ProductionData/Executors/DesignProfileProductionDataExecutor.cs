...
//    private ProfileResult PerformProductionDataProfilePost(DesignProfileProductionDataRequest request)
//    {
//      MemoryStream memoryStream = null;

//      if (!RaptorConverters.DesignDescriptor(request.profileDesign).IsNull())
//      {
...
//          false,
//          //      TWGS84Point.Point(request.wgs84Points.lat1, request.wgs84Points.lon1),
//          //    TWGS84Point.Point(request.wgs84Points.lat2, request.wgs84Points.lon2),
//          startPt,
//          endPt,
//          ValidationConstants.MIN_STATION,
//          ValidationConstants.MAX_STATION,
//          request.profileDesign,
