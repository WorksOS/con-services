...
namespace VSS.Raptor.Service.Common.Proxies
{
    public class SubscriptionProxy : BaseProxy<SubscriptionData>, ISubscriptionProxy
    {
        ...
        public void AssociateProjectSubscription(Guid subscriptionUid, Guid projectUid, IDictionary<string, string> customHeaders = null)
        {
            ...
            SendRequest("ASSOCIATESUBSPROJECT_API_URL", JsonConvert.SerializeObject(payLoadToSend), customHeaders);
        }
    }
}
