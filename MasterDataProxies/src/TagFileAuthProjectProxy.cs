...
namespace VSS.MasterData.Proxies
{
  public class TagFileAuthProjectProxy : BaseProxy, ITagFileAuthProjectProxy
  {
    ...
    public async Task<ContractExecutionResult> GetProjectAndAssetUids(GetProjectAndAssetUidsRequest getProjectAndAssetUidsRequest,
    ...
    public async Task<ContractExecutionResult> GetProjectUid(GetProjectUidRequest getProjectUidRequest,
      IDictionary<string, string> customHeaders = null)
    {
