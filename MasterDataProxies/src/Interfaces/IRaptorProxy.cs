...
namespace VSS.MasterData.Proxies.Interfaces
{
  public interface IRaptorProxy
  {
    ...
    Task<BaseDataResult> AddFile(Guid projectUid, ImportedFileType fileType, DxfUnitsType dxfUnitsType, Guid fileUid, string fileDescriptor, long fileId, IDictionary<string, string> customHeaders = null);
