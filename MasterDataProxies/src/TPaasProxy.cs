...
namespace VSS.MasterData.Proxies
{
  ...
  public class TPaasProxy : BaseProxy, ITPaasProxy
  {
    ...
    public async Task<TPaasOauthResult> Get3DPmSchedulerBearerToken(string grantType, Dictionary<string, string> customHeaders)
    {
      ...
      try
      {
        tPaasOauthResult.tPaasOauthRawResult = await SendRequest<TPaasOauthRawResult>("TPAAS_OAUTH_URL", payLoadToSend, customHeaders, String.Empty, String.Empty, String.Empty);
      }
      catch (Exception e)
      {
