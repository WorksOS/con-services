...
namespace VSS.MasterData.Proxies
{
  ...
  public class RaptorProxy : BaseProxy, IRaptorProxy
  {
    ...
    /// <returns></returns>
    public async Task<BaseDataResult> AddFile(Guid projectUid, ImportedFileType fileType, DxfUnitsType dxfUnitsType, Guid fileUid, string fileDescriptor, long fileId, IDictionary<string, string> customHeaders = null)
    {
