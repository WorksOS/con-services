    ...
    public class StartEndProductionEvents : ProductionEvents<ProductionEventType>
    {
        ...
        public override void Collate()
        {
            ...
            while (I < Events.Count)
            {
                ...
                if (Events[I].State == ProductionEventType.StartRecordedData)
                    NestingLevel++;
                else
                {
                    if (Events[I].State == ProductionEventType.EndRecordedData)
            ...
            while (I < Events.Count - 1)
            {
                ...
                if (Events[I].EquivalentTo(Events[I + 1]) &&
                    Events[I].State == ProductionEventType.StartRecordedData &&
                    Events[I + 1].State == ProductionEventType.EndRecordedData)
                {
        ...
        /// <returns></returns>
        public override Event PutValueAtDate(Event Event)
        {
                ...
                do
                {
                    ...
                    if (ExistingEventFound)
                    {
                        ...
                        else
                        {
                            ...
                            if (Events[EventIndex].State == ProductionEventType.StartRecordedData &&
