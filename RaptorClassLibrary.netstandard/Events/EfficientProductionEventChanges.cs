...
/*
    ...
    public class EfficientProductionEventChanges
    {
        ...
        //        public EfficientStartEndRecordedDataChangeList MachineStartupShutdownEvents;
        public EfficientStartEndRecordedDataChangeList MachineStartupShutdownEvents;
...
//        public EfficientProductionEventChangeList<EfficientProductionEventChangeBase<string>, string> DesignNameStateEvents;
        ...
        private void CreateEventLists()
        {
            MachineStartupShutdownEvents = new EfficientStartEndRecordedDataChangeList(this, MachineID, SiteModel.ID, ProductionEventType.MachineStartupShutdown,
                (w, s) => w.Write((byte)s),
                (r) => (ProductionEventType)r.ReadByte());
...
//                DesignNameStateEvents,
    ...
    public EfficientProductionEventChanges(SiteModel siteModel, long machineID)
        ...
        public bool LoadEventsForMachine(IStorageProxy storageProxy)
        {
            MachineStartupShutdownEvents = MachineStartupShutdownEvents.LoadFromStore(storageProxy) as EfficientStartEndRecordedDataChangeList;
