...
namespace VSS.VisionLink.Raptor.SubGridTrees.Client
{
    ...
    /// </summary>
    public class ClientCMVLeafSubGrid : GenericClientLeafSubGrid<short>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool AssignableFilteredValueIsNull(ref FilteredPassData filteredValue) => filteredValue.FilteredPass.CCV == CellPass.NullCCV;
        ...
        {
            Cells[cellX, cellY] = Context.FilteredValue.FilteredPassData.FilteredPass.CCV;
        }
        ...
        /// <param name="cellY"></param>
        /// <returns></returns>
        public override bool CellHasValue(byte cellX, byte cellY) => Cells[cellX, cellY] != CellPass.NullCCV;
