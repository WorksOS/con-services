namespace VSS.VisionLink.Raptor.SubGridTrees
{
    ...
    /// Existance tracking requires a single bit to be maintained per on-the-ground leaf in the subgrid (ie: leaves existing
    ...
    /// the subgrid cell dimension to correclty represented the spatial coverage of each bit (representing a full subgrid).
    /// </summary>
