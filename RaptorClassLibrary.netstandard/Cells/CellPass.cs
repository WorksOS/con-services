...
namespace VSS.VisionLink.Raptor.Cells
{
    ...
    */
    ...
    public struct CellPass : IEquatable<CellPass>
    {
        ...
        /// <summary>
        /// Maximum temperature value that may be reported
        /// </summary>
        ...
        /// <summary>
        /// Null compaction material temperature value
        /// </summary>
        public const ushort NullMaterialTemp = MaxMaterialTempValue + 1;
        ...
        public void Clear()
        {
            ...
            MaterialTemperature = NullMaterialTemp;
            MDP                 = NullMDP;
