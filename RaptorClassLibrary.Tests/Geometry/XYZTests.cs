...
namespace VSS.VisionLink.Raptor.Geometry.Tests
{
        public class XYZTests
    {
        ...
        public void Test_XYZTests_PointInTriangle()
        {
            ...
            Assert.True(XYZ.PointInTriangle(bottom, top, right, 1.0, 9.0), "Expected point in triangle == true, got {0}", XYZ.PointInTriangle(bottom, top, right, 1.0, 9.0));
            Assert.False(XYZ.PointInTriangle(bottom, top, right, 10, 11), "Expected point in triangle == false, got {0}", XYZ.PointInTriangle(bottom, top, right, 10.0, 11.0));
        }
        ...
        public void Test_XYZTests_PointInTriangleInclusive()
        {
            ...
            Assert.True(XYZ.PointInTriangleInclusive(bottom, top, right, 1.0, 9.0), "0, Expected point in triangle inclusive == true, got {0}", XYZ.PointInTriangleInclusive(bottom, top, right, 1.0, 9.0));
            Assert.True(XYZ.PointInTriangleInclusive(bottom, top, right, 0.0, 0.0), "1, Expected point in triangle inclusive == true, got {0}", XYZ.PointInTriangleInclusive(bottom, top, right, 0.0, 0.0));
            Assert.True(XYZ.PointInTriangleInclusive(bottom, top, right, 0.0, 10.0), "2, Expected point in triangle inclusive == true, got {0}", XYZ.PointInTriangleInclusive(bottom, top, right, 0.0, 10.0));
            Assert.True(XYZ.PointInTriangleInclusive(bottom, top, right, 10.0, 10.0), "3, Expected point in triangle inclusive == true, got {0}", XYZ.PointInTriangleInclusive(bottom, top, right, 10.0, 10.0));
            Assert.True(XYZ.PointInTriangleInclusive(bottom, top, right, 0.0, 5.0), "4, Expected point in triangle inclusive == true, got {0}", XYZ.PointInTriangleInclusive(bottom, top, right, 0.0, 5.0));
        }
        ...
        public void Test_XYZTests_UnitVector()
        {
            ...
            XYZ diff = av - bv;
            Assert.True(XYZ.VectorLength(diff) < 0.00001, "VectorLength for two similar vectors are different: {0} vs {1}", av, bv);
        }
    }
}