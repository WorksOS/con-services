...
namespace VSS.Subscription.Data.Tests
{
  public class ProjectSubs
  {
    ...
    //  private UpdateAssetSubscriptionEvent UpdateAssetSubscriptionEvent(Guid subscriptionGuid, Guid? customerGuid = null, Guid? AssetGuid = null, Guid? DeviceGuid = null,
    ...
    //    var updateAssetSubscription = UpdateAssetSubscriptionEvent(assetSubscription.SubscriptionUID,
    ...
    //    //Create a Same Asset with same Customer
    //    var updateAssetSubscription = UpdateAssetSubscriptionEvent(assetSubscription.SubscriptionUID, AssetGuid: Guid.NewGuid(),
    //        startDate: DateTime.UtcNow.AddDays(-2).Date, endDate: DateTime.UtcNow.AddDays(2).Date);
    //    _subscriptionService.UpdateAssetSubscription(updateAssetSubscription);
    //    var assetFetched = getAssetSubscription(assetSubscription.SubscriptionUID);
    //    Assert.NotNull(assetFetched);
    ...
    //    var updateAssetSubscription = UpdateAssetSubscriptionEvent(assetSubscription.SubscriptionUID, AssetGuid: Guid.NewGuid(), customerGuid: Guid.NewGuid(),
    //        startDate: DateTime.UtcNow.AddDays(-2).Date, endDate: DateTime.UtcNow.AddDays(2).Date);
    //    _subscriptionService.UpdateAssetSubscription(updateAssetSubscription);
    //    var assetFetched = getAssetSubscription(assetSubscription.SubscriptionUID);
    //    Assert.NotNull(assetFetched);
    ...
    //    //Create a New Asset with New Customer
    //    var updateAssetSubscription = UpdateAssetSubscriptionEvent(assetSubscription.SubscriptionUID, AssetGuid: Guid.NewGuid(), customerGuid: new Guid("71d38732-8440-4c0e-a425-c42eef460e91"),
    //        startDate: DateTime.UtcNow.AddDays(-2).Date, endDate: DateTime.UtcNow.AddDays(2).Date);
    //    _subscriptionService.UpdateAssetSubscription(updateAssetSubscription);
    //    var assetFetched = getAssetSubscription(assetSubscription.SubscriptionUID);
    //    Assert.NotNull(assetFetched);
