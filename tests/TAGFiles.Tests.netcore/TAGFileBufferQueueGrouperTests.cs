...
namespace TAGFiles.Tests.netcore
{
    public class TAGFileBufferQueueGrouperTests
    {
        ...
        public void Test_TAGFileBufferQueueGrouper_AddAndExtractTagFile()
        {
            ...
            var noTagFiles = grouper.Extract(new List<Guid>{projectID}, true, out Guid noProjectUID)?.ToList();
            ...
            var tagFiles = grouper.Extract(null, true, out Guid extractedProjectID)?.ToList();
            ...
            var tagFiles2 = grouper.Extract(null, true, out Guid _)?.ToList();
        ...
        public void Test_TAGFileBufferQueueGrouper_AddAndExtractTagFiles()
        {
            ...
            var tagFilesGroup = grouper.Extract(null, true, out Guid _)?.ToList();
            ...
            tagFilesGroup = grouper.Extract(null, true, out Guid _)?.ToList();
            Assert.True(null != tagFilesGroup, "Returned list of grouped tag files is null");
