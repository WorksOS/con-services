...
namespace TAGFiles.Tests.netcore
{
    public class TAGFileBufferQueueGrouperTests
    {
        ...
        public void Test_TAGFileBufferQueueGrouper_AddAndExtractTagFile()
        {
            ...
            var noTagFiles = grouper.Extract(new List<long>{projectID}, true, out long noProjectUID)?.ToList();
            ...
            var tagFiles = grouper.Extract(null, true, out long extractedProjectID)?.ToList();
            ...
            var tagFiles2 = grouper.Extract(null, true, out long _)?.ToList();
        ...
        public void Test_TAGFileBufferQueueGrouper_AddAndExtractTagFiles()
        {
            ...
            var tagFilesGroup = grouper.Extract(null, true, out long _)?.ToList();
            ...
            tagFilesGroup = grouper.Extract(null, true, out long _)?.ToList();
            Assert.True(null != tagFilesGroup, "Returned list of grouped tag files is null");
