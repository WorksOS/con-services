...
namespace TAGFiles.Tests.netcore
{
    public class TAGFileBufferQueueGrouperTests
    {
        ...
        public void Test_TAGFileBufferQueueGrouper_AddAndExtractTagFile()
        {
            ...
            var noTagFiles = grouper.Extract(new List<long>{projectID}, out long noProjectUID)?.ToList();
            ...
            var tagFiles = grouper.Extract(null, out long extractedProjectID)?.ToList();
            ...
            var tagFiles2 = grouper.Extract(null, out long _)?.ToList();
        ...
        public void Test_TAGFileBufferQueueGrouper_AddAndExtractTagFiles()
        {
            ...
            var tagFilesGroup = grouper.Extract(null, out long _)?.ToList();
            ...
            tagFilesGroup = grouper.Extract(null, out long _)?.ToList();
            Assert.True(null != tagFilesGroup, "Returned list of grouped tag files is null");
