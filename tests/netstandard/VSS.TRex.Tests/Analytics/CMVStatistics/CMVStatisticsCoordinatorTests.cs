...
namespace VSS.TRex.Tests.Analytics.CMVStatistics
{
  public class CMVStatisticsCoordinatorTests : BaseCoordinatorTests
  {
    ...
    private CMVStatisticsAggregator _getCMVAggregator()
    {
    ...
    [Fact]
    public void Test_CMVStatisticsCoordinator_ConstructAggregator_Successful()
    {
    ...
    [Fact]
    public void Test_CMVStatisticsCoordinator_ReadOutResults_Successful()
    {
      var aggregator = _getCMVAggregator();
      var coordinator = _getCoordinator();
