...
namespace VSS.TRex.Tests.Analytics.PassCountStatistics
{
  public class PassCountStatisticsCoordinatorTests : BaseCoordinatorTests
  {
    ...
    private PassCountStatisticsAggregator _getPassCountAggregator()
    {
    ...
    [Fact]
    public void Test_PassCountStatisticsCoordinator_ConstructAggregator_Successful()
    {
    ...
    [Fact]
    public void Test_PassCountStatisticsCoordinator_ReadOutResults_Successful()
    {
      var aggregator = _getPassCountAggregator();
      var coordinator = _getCoordinator();
