...
Scenario Outline: Compaction Get Tiles
  ...
  And displayMode "4" and bbox "<BBox>" and width "<Width>" and height "<Height>"
	...
	Then the result should match the "<ResultName>" from the repository
	Examples: 
  | RequetsName      | ProjectUID                           | FilterUID                            | BBox                                           | Width | Height | ResultName       |
  ...
  | DesignIntersepts | 7925f179-013d-4aaf-aff4-7b9833bb06d6 | 81422acc-9b0c-401c-9987-0aedbf153f1d | 36.207022, -115.020854, 36.207563, -115.018414 | 256   | 64     | DesignIntersepts |
