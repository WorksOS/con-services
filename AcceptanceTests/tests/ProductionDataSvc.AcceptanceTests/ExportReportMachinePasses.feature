...
Scenario Outline: ExportReportMachinePasses - Good Request
  ...
  And rawDataOutput "<RawDataOutput>"
	...
	Examples: 
	| RequetsName                   | ProjectUID                           | StartDate  | EndDate    | CoordType | OutputType | RestrictOutput | RawDataOutput | FileName | ResultName                    |
...
Scenario Outline: ExportReportMachinePasses - Bad Request - NoProjectUID
  ...
  And rawDataOutput "<RawDataOutput>"
	...
	Examples:
	| RequetsName | StartDate  | EndDate    | CoordType | OutputType | RestrictOutput | RawDataOutput | FileName | ErrorCode | ErrorMessage        |
	|             | 2005-01-01 | 2017-06-23 | 0         | 0          | false          | false         | Test     | -2        | Missing project UID |
...
Scenario Outline: ExportReportMachinePasses - Bad Request - NoDateRange
  ...
  And rawDataOutput "<RawDataOutput>"
	...
	Then the report result should contain error code <ErrorCode> and error message "<ErrorMessage>"
	Examples:
	| RequetsName | ProjectUID                           | CoordType | OutputType | RestrictOutput | RawDataOutput | FileName | ErrorCode | ErrorMessage                        |
...
Scenario Outline: ExportReportMachinePasses - Bad Request - NoFileName
  ...
  And rawDataOutput "<RawDataOutput>"
	...
	Then the report result should contain error code <ErrorCode> and error message "<ErrorMessage>"
	Examples:
	| RequetsName | ProjectUID                           | StartDate  | EndDate    | CoordType | OutputType | RestrictOutput | RawDataOutput | ErrorCode | ErrorMessage                        |
