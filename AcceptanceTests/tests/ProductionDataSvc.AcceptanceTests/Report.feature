...
Scenario Outline: Station offset Report
  ...
  And I set request parameters projectUid 'ff91dd40-1569-4765-a2bc-014321f76ace' and filterUid '<filterUid>'
  And I select columns '<Elevation>' '<CMV>' '<MDP>' '<PassCount>' '<Temperature>' '<CutFill>'
  And I select Station offset report parameters '<cutfillDesignUid>' '<filterUid>' '<cutfillDesignUid>' '<crossSectionInterval>' '<startStation>' '<endStation>' '<offsets>' 
  ...
  Examples:                           
  | ResultName  | Elevation | CMV | MDP | PassCount | Temperature | CutFill | filterUid                            | cutfillDesignUid                     | crossSectionInterval | startStation | endStation | offsets           | httpCode | errorCode |
  | NoColumns   | N         | N   | N   | N         | N           | N       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 3ead0c55-1e1f-4d30-aaf8-873526a2ab82 | 0.5                  | 0.0          | 1.75       | -1, 0.5           | 400      | -1        |
  | AllColumns  | Y         | Y   | Y   | Y         | Y           | Y       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 3ead0c55-1e1f-4d30-aaf8-873526a2ab82 | 0.5                  | 0.0          | 1.75       | -1, 0.5           | 200      | 0         |
  | Elevation   | Y         | N   | N   | N         | N           | N       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 6ece671b-7959-4a14-86fa-6bfe6ef4dd62 | 1.2                  | 0.0          | 4          | -1, -1.3, -2, 1.5 | 200      | 0         |
  | CMV         | N         | Y   | N   | N         | N           | Y       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 6ece671b-7959-4a14-86fa-6bfe6ef4dd62 | 0.5                  | 0.0          | 4          | -1, -1.3, 1       | 200      | 0         |
  | MDP         | N         | N   | Y   | N         | N           | N       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 6ece671b-7959-4a14-86fa-6bfe6ef4dd62 | 0.5                  | 0.0          | 4          | -1, -1.3, 1       | 200      | 0         |
  | PassCount   | N         | N   | N   | Y         | N           | N       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 6ece671b-7959-4a14-86fa-6bfe6ef4dd62 | 1.2                  | 0.0          | 4          | -1, -1.3, -2, 1.5 | 200      | 0         |
  | CutFill     | N         | N   | N   | N         | N           | Y       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 6ece671b-7959-4a14-86fa-6bfe6ef4dd62 | 0.5                  | 0.0          | 4          | -1, -1.3, 1       | 200      | 0         |
  | Temperature | N         | N   | N   | N         | Y           | N       | 3ef41e3c-d1f5-40cd-b012-99d11ff432ef | 6ece671b-7959-4a14-86fa-6bfe6ef4dd62 | 0.5                  | 0.0          | 4          | -1, -1.3, 1       | 200      | 0         |
