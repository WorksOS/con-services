...
#line hidden
        ...
        public virtual void CompactionGetTemperatureSummary(string requetsName, string projectUID, string filterUID, string resultName, string[] exampleTags)
        {
...
#line hidden
        ...
        public virtual void CompactionGetTemperatureSummary_DesignIntersepts()
        {
            this.CompactionGetTemperatureSummary("DesignIntersepts", "7925f179-013d-4aaf-aff4-7b9833bb06d6", "3d9086f2-3c04-4d92-9141-5134932b1523", "DesignIntersepts_Summary", ((string[])(null)));
        }
    }
}
