...
#line hidden
        ...
        {
            this.ExportReportToSurface_GoodRequest("With Tolerance", "7925f179-013d-4aaf-aff4-7b9833bb06d6", "0.05", "Test", "WithTolerance", ((string[])(null)));
        }
...
#line hidden
        ...
        {
            this.ExportReportToSurface_GoodRequest_NoTolerance("", "7925f179-013d-4aaf-aff4-7b9833bb06d6", "Test", "NoTolerance", ((string[])(null)));
        }
...
#line hidden
        ...
        public virtual void ExportReportToSurface_BadRequest_NoFileName(string requetsName, string tolerance, string errorCode, string errorMessage, string[] exampleTags)
        {
...
#line hidden
        ...
        {
            this.ExportReportToSurface_BadRequest_NoFileName("", "0.05", "-4", "Failed to get requested export data", ((string[])(null)));
        }
    }
}
