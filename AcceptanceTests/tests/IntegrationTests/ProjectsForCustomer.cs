...
//using System.Net;
//using TestUtility.Model.DBModels;
...
//      DateTime startDate = testSupport.ConvertTimeStampAndDayOffSetToDateTime("0d+00:00:00");
//      DateTime endDate = testSupport.ConvertTimeStampAndDayOffSetToDateTime("1000d+00:00:00");
...
//      testSupport.PublishEventCollection(geofenceEventArray);
...
//      DateTime startDate = testSupport.ConvertTimeStampAndDayOffSetToDateTime("0d+00:00:00");
//      DateTime endDate = testSupport.ConvertTimeStampAndDayOffSetToDateTime("400d+00:00:00");
...
//      testSupport.CreateMockProjectSubscription(projectGuid.ToString(), Guid.NewGuid().ToString(), customerGuid.ToString(), 20, startDate, endDate, startDate);
