  ...
  public static class Auth
  {
    ...
    public static string GetVlSessionId()
    {
      ...
      using (var client = new HttpClient())
      {
        ...
        var response = client.PostAsJsonAsync(formanUri, request).Result;
    ...
    {
      var formanUri = "https://dev-mobile.vss-eng.com/Foreman/Secure/ForemanSvc.svc/GetTCCDetails";
      var vlSessionId = GetVlSessionId();
