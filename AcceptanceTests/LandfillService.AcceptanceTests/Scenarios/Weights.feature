...
Scenario: Add weight multi days
	When I add weights for the past 7 days to project 'Casella-Stanley Landfill'
	Then the weights are added for the past 7 days to project 'Casella-Stanley Landfill'
