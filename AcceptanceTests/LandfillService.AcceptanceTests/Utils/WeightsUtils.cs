...
namespace LandfillService.AcceptanceTests.Utils
{
    ...
    {
        public static DateTime ConvertToProjectTime(DateTime systemTime, string projectTimeZone)
        {
            TimeZoneInfo projZoneInfo = OlsonTimeZoneToTimeZoneInfo(projectTimeZone);
            return systemTime.ToUniversalTime().Add(projZoneInfo.BaseUtcOffset);
        }
        ...
        private static TimeZoneInfo OlsonTimeZoneToTimeZoneInfo(string olsonTimeZoneId)
        {
            ...
            #region Olson time zone to Win32 time zone table
