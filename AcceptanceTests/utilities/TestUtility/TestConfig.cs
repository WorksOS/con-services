...
namespace TestUtility
{
    ...
    public class TestConfig
    {
        ...
        public string mySqlServer = Environment.GetEnvironmentVariable("MYSQL_SERVER_NAME_VSPDB"); 
        ...
        public string dbSchema = Environment.GetEnvironmentVariable("MYSQL_DATABASE_NAME");
