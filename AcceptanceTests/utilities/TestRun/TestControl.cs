  ...
  public class TestControl
    {
        ...
        public bool RunAllTests(string[] arguments)
        {
            try
            {
                ...
                Console.WriteLine("Current=" + currentPath + projectName);
                //var assembly = LoadAssembly(currentPath + projectName);
        ...
        private bool GetAllClassesInAssemblyAndRunTests(Assembly assembly, Type[] classes)
      {
        ...
        foreach (var current in classes)
        {
          ...
          if (current.Name.ToLower() == "autogeneratedprogram")
          {
            continue;
          }
          try
    ...
    private void RunAnyTestInitializeMethods(Type current, object instance)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.WriteLine(@"=================================================================================================");
          Console.WriteLine("TestInitialize method : " + initializeMethod.Name + " ***********  FAILED ************ ");
