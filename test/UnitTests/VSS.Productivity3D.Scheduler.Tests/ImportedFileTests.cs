...
namespace VSS.Productivity3D.Scheduler.Tests
{
  ...
  public class ImportedFileTests : BaseTests
  {
    ...
    public async Task CanGet3DpmBearerTokenMoq()
    {
      ...
      var importFileSync = new ImportedFileSynchronizerBase(_configStore, _logger, raptorProxy.Object, tPaasProxy.Object, impFileProxy.Object, fileRepo.Object, true);
