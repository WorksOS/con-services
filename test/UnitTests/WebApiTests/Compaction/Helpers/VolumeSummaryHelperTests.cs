    ...
    public class GetVolumesType : VolumeSummaryHelperTests
    {
      ...
      public static void ClassInit(TestContext context)
      {
        filter = Filter.CreateFilter(
            0, "name", "desc", DateTime.Now, DateTime.Now, 1, null, false, false, ElevationType.Highest, new List<WGSPoint>(), new List<Point>(), false, null, 0, 0, 0, 0, "designName", FilterLayerMethod.None, null, 0, 0, 0, new List<MachineDetails>(), new List<long>(), true, GPSAccuracy.Coarse, false, false, false, false);
      }
