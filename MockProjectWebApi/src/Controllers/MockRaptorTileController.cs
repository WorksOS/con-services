  ...
  public class MockRaptorTileController : Controller
  {
      ...
      [FromQuery] VolumeCalcType? volumeCalcType)
    {
      ...
      if (projectUid.ToString() == "ff91dd40-1569-4765-a2bc-014321f76ace")
      {
        ...
        {
          return "0.63193334655142608,-2.0074700318202785,0.63193798363215326,-2.0074375366860844";
        }

        if (cutFillDesignUid.ToString() == "dd64fe2e-6f27-4a78-82a3-0c0e8a5e84ff")
        {
          return "0.63193254909347829,-2.0074890677373083,0.63194015872901688,-2.0074520667571658";
        }
        ...
        {
          //DesignToGround
          return "0.63193312505213139,-2.00747079414004,0.6319399492895067,-2.0074496756560909";
        }
        ...
        {
          //GroundToGround
          return "0.63192459673759782,-2.0075399142785511,0.63192486410371329,-2.0075397823184482";
        }
        return "0.631904485465203,-2.00758733949739,0.631987283352491,-2.0074375366860844";
      }
