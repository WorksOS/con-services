...
[Environment]::SetEnvironmentVariable("RAPTOR_NOTIFICATION_API_URL", "http://mockprojectwebapi:5001/api/v2/notification/addfile", "Machine")
...
[Environment]::SetEnvironmentVariable("PROJECTSETTINGS_API_URL", "http://mockprojectwebapi:5001/api/v2/compaction/validatesettings", "Machine")
