...
.\tools\opencover.console.exe -target:"dotnet.exe"  -targetargs:"test test\UnitTests\MasterDataConsumerTests\MasterDataConsumerTests.csproj" -mergeoutput -hideskipped:File -output:coverage.xml -register:user
